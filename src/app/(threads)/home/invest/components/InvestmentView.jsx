...
const InvestmentView = ({investment}) => {
  const [selectedImageIndex, setSelectedImageIndex] = useState(0);

    const mediaArray = [...(investment?.pictures || []), ...(investment?.videos || [])];
    ...
    const handleNextImage = () => {
        if (selectedImageIndex < investment.pictures.length + investment.videos.length - 1) {
